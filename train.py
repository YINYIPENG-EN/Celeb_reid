...
def main(args):
    ...
    model = nn.DataParallel(model).cuda()  # DP
...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('--train_path', type=str, default='/datasets/celeb/train', help="train image with soft mask")
    parser.add_argument('--gallery_path', type=str, default='/datasets/celeb/gallery', help="gallery image with soft mask")
    parser.add_argument('--query_path', type=str, default='/datasets/celeb/query', help="query image with soft mask")
